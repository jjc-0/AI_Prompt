...
const agents: Agent[] = [
  ...
  },
  {
    id: "copywriting",
    name: "文案生成 Agent",
    description: "一键生成多平台营销文案、产品描述、询盘回复邮件，支持多语言与多人协作。",
  ...
  },
  {
    ...
    name: "AI 视觉识图 Agent",
    description: "GPT-4 Vision 驱动，识别产品图片、竞品包装、生产工艺等多场景图像。",
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">选择 AI Agent 开始对话 · 自动化你的业务</p>
        </div>
